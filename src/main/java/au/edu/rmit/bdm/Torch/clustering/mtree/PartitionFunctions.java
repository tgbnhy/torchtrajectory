...
public final class PartitionFunctions {
	...
	public static class BalancedPartition<DATA> implements PartitionFunction<DATA> {
		 ...
		 * </pre>
		 * 
		 * @see au.edu.rmit.bdm.Torch.clustering.mtree.PartitionFunction#process(au.edu.rmit.bdm.Torch.clustering.mtree.utils.Pair, java.util.Set, au.edu.rmit.bdm.Torch.clustering.mtree.DistanceFunction)
		 */
		@Override
